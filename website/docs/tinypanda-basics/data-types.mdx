...
### Creating an Array
Arrays are initialized using square brackets `[...]` with elements separated by commas `,`. You can assign them to identifiers using the `bamboo` keyword just like any other data type:
