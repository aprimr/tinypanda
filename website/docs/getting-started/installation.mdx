...
1. Download `tinypanda-windows.exe` from the [latest release](https://github.com/aprimr/tinypanda/releases/latest) or [Download]() page.
...
Continue to [Hello TinyPanda](./hello-tinypanda) to write and run your first program.